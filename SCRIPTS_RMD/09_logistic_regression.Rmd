...
# Select the best threshold. We select it in order to obtain 85% as sensitivity because we want a screeening test that is able to reduce at most the false negatives without impact too much the specificity. Diagnostic second level test can be then used to avoid false positives
...
train_set <- train_set[,-c(1,2, 3, 7,8,9,11, 14, 16, 17, 18, 19)]
test_set <- test_set[,-c(1, 2, 3, 7,8,9,11, 14, 16, 17, 18, 19)]
